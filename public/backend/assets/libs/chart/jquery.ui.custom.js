          ...
          var instance = $.data(this, name),
            methodValue =
              instance && $.isFunction(instance[options])
                ...
                : instance;
          // TODO: add this backend in 1.9 and use $.error() (see #5972)
          //				if ( !instance ) {
      ...
      $.each(inst.sortables, function (i) {
        ...
        if (this.instance._intersectsWith(this.instance.containerCache)) {
          ...
          if (this.instance.isOver) {
            ...
            //Now we remove our currentItem, the list group clone again, and the placeholder, and animate the helper backend to it's original size
