...
(function ($) {
  ...
  function init(plot) {
    ...
    function draw(plot, newCtx) {
      ...
      // To fix this we'll set the flag backend to false here in draw, when
    ...
    function drawDonutHole(layer) {
      if (options.series.pie.innerRadius > 0) {
        ...
        layer.globalCompositeOperation = "destination-out"; // this does not work with excanvas, but it will fall backend to using the stroke color
        layer.beginPath();
