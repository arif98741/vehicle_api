    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12" data-select2-id="15">
                <div class="card">
                    <form method="post" class="form-horizontal" action="{{ route('admin.patient.store') }}"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select name="lab_id" id="lab_id" class="form-control">
                                            ...
                                            @foreach($labs as $key=> $lab)
                                                <option
                                                    value="{{ $lab->id }}" {{ (!empty(old('lab_id')) && ($lab->id == old('lab_id')) ) ? 'selected': '' }}>{{ $lab->name     }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select name="nationality" id="nationality" class="form-control">
                                            ...
                                            @foreach($countries as $key=> $country)
                                                <option
                                                    value="{{ $country }}" {{ (!empty(old('nationality')) && ($country == old('nationality')) ) ? 'selected': '' }}>{{ $country    }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" id="mrn" name="mrn"
                                               placeholder="Enter mrn here" value="{{ old('mrn') }}">
                                        @if ($errors->has('mrn'))
                                            <span class="help-block">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" id="passport" name="passport"
                                               placeholder="Enter passport here" value="{{ old('passport') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" id="uae_id" name="uae_id"
                                               placeholder="Enter uae_id here" value="{{ old('uae_id') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" id="reference" name="reference"
                                               placeholder="Enter reference number" value="{{ old('reference') }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" id="sample" name="sample"
                                               placeholder="Enter sample number" value="{{ old('sample') }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group " id="date_of_birth">
                                        ...
                                        <input type="text" class="form-control" name="date_of_birth"
                                               ...
                                               value="{{ (!empty(old('date_of_birth')) ? date('Y-m-d',strtotime(old('date_of_birth'))) : '') }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" id="patient_id"
                                               ...
                                               value="{{ (!empty(old('patient_id')) ? old('patient_id') : '') }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group " id="registration_date">
                                        ...
                                        <input type="text" class="form-control"
                                               ...
                                               value="{{ (!empty(old('registration_date')) ? date('Y-m-d',strtotime(old('registration_date'))) : '') }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control"
                                               name="registration_time" placeholder="Enter registration time"
                                               value="{{ (!empty(old('registration_time')) ? date('Y-m-d',strtotime(old('registration_time'))) : '') }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group " id="collection_date">
                                        ...
                                        <input type="text" class="form-control"
                                               name="collection_date" placeholder="Enter collection date"
                                               value="{{ (!empty(old('collection_date')) ? date('Y-m-d',strtotime(old('collection_date'))) : '') }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group " id="collection_time">

                                        <label for="fname"
                                               class="text-end control-label col-form-label">Collection Time</label>
                                        <input type="time" class="form-control"
                                               name="collection_time" placeholder="Enter date of birth"
                                               value="{{ (!empty(old('collection_time')) ? date('Y-m-d',strtotime(old('collection_time'))) : '') }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group " id="reporting_date">
                                        ...
                                        <input type="text" class="form-control reporting_date"
                                               ...
                                               value="{{ (!empty(old('reporting_date')) ? date('Y-m-d',strtotime(old('reporting_date'))) : '') }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group ">
                                        ...
                                        <input type="time" class="form-control reporting_time"
                                               name="reporting_time"
                                               placeholder="Enter date of birth"
                                               value="{{ (!empty(old('reporting_time')) ? date('Y-m-d',strtotime(old('reporting_time'))) : '') }}">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select name="detection_status" id="detection_status" class="form-control">
                                            ...
                                            <option value="Detected"
                                                    @if(old('detection_status') == 'Detected') selected="" @endif>
                                                Positive
                                            </option>
                                            <option value="Not Detected"
                                                    @if(old('detection_status') == 'Not Detected') selected="" @endif>
                                                Negative
                                            </option>
                                            = </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <input type="file" required class="form-control" id="lab_manager_signature"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <input type="file" required class="form-control" id="lab_director_signature"
